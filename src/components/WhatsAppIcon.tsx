...
export function WhatsAppIcon({ size = 20, className = "", colored = false, ...props }: WhatsAppIconProps) {
  if (colored) {
    return (
      <div 
        className={`inline-flex items-center justify-center rounded-full bg-[#25D366] text-white overflow-hidden shadow-sm shadow-[#25D366]/20 ${className}`}
