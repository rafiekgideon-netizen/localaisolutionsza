...
export function Chatbot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      <div 
        className={`fixed bottom-20 md:bottom-8 right-4 sm:right-6 md:right-8 z-50 w-[calc(100vw-32px)] sm:w-[calc(100vw-48px)] md:w-[380px] max-w-[calc(100vw-32px)] h-[500px] max-h-[calc(100vh-140px)] md:max-h-[calc(100vh-96px)] rounded-sm border border-[rgba(255,255,255,0.1)] bg-[#111111] shadow-2xl flex flex-col overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${isOpen ? 'translate-y-0 opacity-100 pointer-events-auto' : 'translate-y-12 opacity-0 pointer-events-none'}`}
      >
        {/* Header */}
