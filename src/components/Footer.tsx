      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          <div className="md:col-span-1">
            <a href="#home" aria-label="Local AI Solutions Home" className="flex items-center text-white no-underline mb-6">
              <img 
        ...
        <div className="pt-8 border-t border-[rgba(255,255,255,0.06)] dark:border-[rgba(255,255,255,0.06)] border-slate-200 flex flex-col md:flex-row items-center justify-between gap-6">
