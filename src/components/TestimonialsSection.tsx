...
import { TestimonialsSkeleton } from "./SectionSkeletons";
...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="section-padding bg-[var(--color-primary)] border-t border-[var(--color-border)] relative overflow-hidden">
      ...
      <div className="absolute left-1/3 top-1/2 w-72 sm:w-96 h-72 sm:h-96 max-w-full bg-[var(--color-tertiary)] opacity-[0.02] blur-[120px] rounded-full pointer-events-none" />
        ...
        >
          <div className="min-h-[460px] md:min-h-[380px] lg:min-h-[320px] flex items-center">
            <AnimatePresence mode="wait">
              {isInitializing ? (
                <TestimonialsSkeleton key="testimonials-skeleton" />
              ) : (
                <motion.div
                  key={currentIndex}
